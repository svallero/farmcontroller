...
func init() {
	...
	_ = farmcontrollerv1alpha1.AddToScheme(scheme)
...
func main() {
	...
	if err = (&controllers.FarmReconciler{
		Client:   mgr.GetClient(),
		Log:      ctrl.Log.WithName("controllers").WithName("Farm"),
		Recorder: mgr.GetEventRecorderFor("Farm"),
